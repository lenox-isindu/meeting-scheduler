...
document.addEventListener("DOMContentLoaded", function() {
    // Array of video sources (update paths as needed)
    const videos = [
  ...
  document.addEventListener("DOMContentLoaded", function () {
    // Typing effect
    const messages = ["At Meeting Scheduler, we turn every meeting into a strategic opportunity", "Enjoy a seamless experience that empowers you to control your time and drive success!", "Plan ahead and never miss a meeting."];
    let messageIndex = 0;
    let charIndex = 0;
    let typingMessage = document.getElementById("welcome-message");
